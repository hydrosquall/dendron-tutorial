...
function initSearch() {
  ...
  request.open('GET', 'https://github.com/hydrosquall/dendron-tutorial/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'https://github.com/hydrosquall/dendron-tutorial/assets/css/just-the-docs-' + theme + '.css');
}
