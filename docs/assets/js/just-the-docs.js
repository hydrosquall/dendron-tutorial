...
function initSearch() {
  ...
  request.open('GET', 'https://hydrosquall.github.io/dendron-tutorial/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'https://hydrosquall.github.io/dendron-tutorial/assets/css/just-the-docs-' + theme + '.css');
}
